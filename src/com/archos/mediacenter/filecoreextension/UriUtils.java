   ...
   */
    ...
    public static boolean isValidPath(String pathname) {
        ...
        try {
            ...
            log.debug("isValidPath: input={} -> canonicalPath={}", pathname, canonicalPath);
    ...
    public static boolean isValidStringUri(String uriString) {
        ...
        try {
            ...
            if (sIndexableSchemes.contains(scheme)) {
                ...
                log.debug("isValidStringUri: input={} -> scheme={} host={} port={} path={} ", uriString, scheme, host, port, path);
            ...
            log.error("isValidStringUri: input={} -> URISyntaxException", uriString, e);
            return false;
        }
    }
