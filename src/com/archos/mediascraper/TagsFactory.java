...
public class TagsFactory {
    ...
    private static class Columns {
        public Columns(Cursor c) {
            ...
            spokenlanguagesME = getCol(c, VideoColumns.SCRAPER_SPOKENLANGUAGES);
            countriesME = getCol(c, VideoColumns.SCRAPER_COUNTRIES);
            // unused?
            ...
            spokenlanguagesS = getCol(c, VideoColumns.SCRAPER_S_SPOKENLANGUAGES);
            countriesS = getCol(c, VideoColumns.SCRAPER_S_COUNTRIES);
        ...
        public final int spokenlanguagesME;
        public final int countriesME;
        ...
        public final int spokenlanguagesS;
        public final int countriesS;
    ...
    public static final String[] VIDEO_COLUMNS = {
        ...
        VideoColumns.SCRAPER_WRITERS,
            ...
            VideoColumns.SCRAPER_SPOKENLANGUAGES,
            VideoColumns.SCRAPER_COUNTRIES,
        ...
        VideoColumns.SCRAPER_S_WRITERS,
            ...
            VideoColumns.SCRAPER_S_SPOKENLANGUAGES,
    ...
    */
	...
	public static List<BaseTags> buildTagsFromVideoCursor(Cursor cur) {
        ...
        while (cur.moveToNext()) {
            ...
            String spokenlanguagesME = getStringCol(cur, cols.spokenlanguagesME);
            ...
            if (scraperType == ScraperStore.SCRAPER_TYPE_MOVIE) {
                ...
                tag.setSpokenlanguagesFormatted(spokenlanguagesME);
                ...
                epTag.setSpokenlanguagesFormatted(spokenlanguagesME);
                epTag.setCountriesFormatted(countriesME);
                ...
                if(sTag == null) {
                    ...
                    String spokenlanguagesS =getStringCol(cur, cols.spokenlanguagesS);
                    ...
                    sTag.setSpokenlanguagesFormatted(spokenlanguagesS);
    ...
    public static List<MovieTags> buildMovieFromCursor(Cursor cur) {
        ...
        do {
            ...
            String spokenlanguage = getStringCol(cur, ScraperStore.Movie.Spokenlanguage.NAME);
            ...
            tag.addSpokenlanguageIfAbsent(spokenlanguage);
    ...
    public static List<ShowTags> buildShowFromCursor(Cursor cur) {
        ...
        do {
            ...
            String spokenlanguage = getStringCol(cur, ScraperStore.Show.Spokenlanguage.NAME);
            String country = getStringCol(cur, ScraperStore.Show.Country.NAME);
    ...
    public static List<EpisodeTags> buildEpisodeFromCursor(Cursor cur) {
        ...
        do {
            ...
            String spokenlanguage = getStringCol(cur, ScraperStore.Episode.Spokenlanguage.NAME);
            String country = getStringCol(cur, ScraperStore.Episode.Country.NAME);
    ...
    public static MovieTags buildMovieTags(Context context, long movieId) {
        ...
        if (result != null) {
            ...
            // Producers
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Producer.URI.MOVIE, movieId),
                    new String[] {
                            ScraperStore.Movie.Producer.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    result.addProducerIfAbsent(c.getString(0));
                }
                c.close();
            }
            // Screenplays
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Screenplay.URI.MOVIE, movieId),
                    new String[] {
                            ScraperStore.Movie.Screenplay.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
            ...
            // Spokenlanguages
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Spokenlanguage.URI.MOVIE, movieId),
                    new String[] {
                            ScraperStore.Movie.Spokenlanguage.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    result.addSpokenlanguageIfAbsent(c.getString(0));
                }
                c.close();
            }
            // Countries
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Country.URI.MOVIE, movieId),
                    new String[] {
                            ScraperStore.Movie.Country.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    result.addCountryIfAbsent(c.getString(0));
                }
                c.close();
            }
            // Genres
    ...
    public static EpisodeTags buildEpisodeTags(Context context, long episodeId) {
        ...
        if (result != null) {
            ...
            // Producers
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Producer.URI.EPISODE, episodeId),
                    new String[] {
                            ScraperStore.Episode.Producer.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    result.addProducerIfAbsent(c.getString(0));
            ...
            // Screenplays
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Screenplay.URI.EPISODE, episodeId),
                    new String[] {
                            ScraperStore.Episode.Screenplay.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    result.addScreenplayIfAbsent(c.getString(0));
            ...
            // Spokenlanguages
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Spokenlanguage.URI.EPISODE, episodeId),
                    new String[] {
                            ScraperStore.Episode.Spokenlanguage.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    result.addSpokenlanguageIfAbsent(c.getString(0));
    ...
    public static ShowTags buildShowTagsFromCursor(Context context, Cursor c, long showId) {
        ...
        if (showTags != null) {
            ...
            // Producers
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Producer.URI.SHOW, showId),
                    new String[] {
                            ScraperStore.Show.Producer.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    showTags.addProducerIfAbsent(c.getString(0));
                }
                c.close();
            }
            // Screenplays
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Screenplay.URI.SHOW, showId),
                    new String[] {
                            ScraperStore.Show.Screenplay.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
            ...
            // Spokenlanguages
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Spokenlanguage.URI.SHOW, showId),
                    new String[] {
                            ScraperStore.Show.Spokenlanguage.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    showTags.addSpokenlanguageIfAbsent(c.getString(0));
                }
                c.close();
            }
            // Countries
            c = cr.query(
                    ContentUris.withAppendedId(ScraperStore.Country.URI.SHOW, showId),
                    new String[] {
                            ScraperStore.Show.Country.NAME,            // 0
                    }, null, null, null);
            if (c != null) {
                while (c.moveToNext()) {
                    showTags.addCountryIfAbsent(c.getString(0));
                }
                c.close();
            }
            // SeasonPlots
