...
public class VideoOpenHelper extends DeleteOnDowngradeSQLiteOpenHelper {
    ...
    private static final String CREATE_VIDEO_VIEW_V32 =
            "CREATE VIEW " + VIDEO_VIEW_NAME + " AS SELECT \n" +
                    ...
                    "    coalesce(msl.m_sl_large_url, studiologo_url_movie) AS m_sl_url,\n" +
                    "    coalesce(msl.m_sl_large_file, studiologo_movie) AS m_sl_file,\n" +
                    "    coalesce(mcl.m_cl_large_url, clearlogo_url_movie) AS m_cl_url,\n" +
                    "    coalesce(mcl.m_cl_large_file, clearlogo_movie) AS m_cl_file,\n" +
                    ...
                    "    msl._id AS m_studiologo_id,\n" +
                    "    mcl._id AS m_clearlogo_id,\n" +
                    ...
                    "       LEFT JOIN movie_studiologos AS msl ON ( m.m_studiologo_id = msl._id )\n" +
                    "       LEFT JOIN movie_clearlogos AS mcl ON ( m.m_clearlogo_id = mcl._id )\n" +
    ...
    private static final String CREATE_VIDEO_VIEW_V41 =
            "CREATE VIEW " + VIDEO_VIEW_NAME + " AS SELECT \n" +
                    ...
                    "    e_writers,\n" +
                    "    s_writers,\n" +
                    "    coalesce(m_taglines, e_taglines) AS taglines,\n" +
                    "    m_taglines,\n" +
                    "    e_taglines,\n" +
                    "    s_taglines,\n" +

                    "    coalesce(m_producers, e_producers) AS producers,\n" +
                    "    m_producers,\n" +
                    "    e_producers,\n" +
                    "    s_producers,\n" +

                    "    coalesce(m_screenplays, e_screenplays) AS screenplays,\n" +
                    "    m_screenplays,\n" +
                    "    e_screenplays,\n" +
                    "    s_screenplays,\n" +

                    "    coalesce(m_musiccomposers, e_musiccomposers) AS musiccomposers,\n" +
                    "    m_musiccomposers,\n" +
                    "    e_musiccomposers,\n" +
                    "    s_musiccomposers,\n" +
